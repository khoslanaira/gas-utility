# Generated by Django 5.1.7 on 2025-03-27 22:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('request_type', models.CharField(choices=[('LEAK', 'Gas Leak'), ('BILLING', 'Billing Issue'), ('MAINTENANCE', 'Maintenance Request'), ('OTHER', 'Other')], max_length=20)),
